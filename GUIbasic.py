...
from tkinter import * #library we are using
#parent window
root = Tk()
...
weover = Menu(root) #sub menu 2
weover.add_command(label='Are you sure')

main_menu.add_command(label='Medi Purpose', menu= file_menu)
main_menu.add_command(label='Edit')
main_menu.add_command(label='we over', menu = weover)
